        ...
        if st.session_state.get("vector_db_initialized", False):
            try:
                ...
                if last_user_message:
                    # Enhance the prompt with Vector DB data
...
```json
{
  ...
  "strategic_buyers": [
    {
      ...
      "strategic_rationale": "SEA market entry with established platform",
      "key_synergies": "Data analytics, technology platform, corporate relationships",
      "concerns": "Regulatory complexity, valuation expectations",
      "fit_score": "High (9/10)",
    ...
    },
    {
      ...
      "concerns": "Asset-heavy model transition",
      "fit_score": "Medium-High (7/10)",
    ...
    },
    {
      ...
      "concerns": "Service line alignment",
      "fit_score": "Medium (6/10)",
  ...
  "financial_buyers": [
    {
      ...
      "strategic_rationale": "Buy-and-build platform strategy across SEA",
      "key_synergies": "Operational excellence, technology investment",
      "concerns": "Valuation discipline, exit timeline",
      "fit_score": "Very High (9/10)",
    ...
    },
    {
      ...
      "concerns": "Competitive process, control preferences", 
      "fit_score": "High (8/10)",
    ...
    },
    {
      ...
      "concerns": "Integration complexity, timing",
      "fit_score": "High (8/10)",
  ...
  "investor_process_data": {
    ...
    "timeline": [
      {
        "date": "Week 1-2",
        "description": "Due diligence package and management presentations"
      },
      {
        "date": "Week 3-4",
        "description": "Site visits and detailed financial analysis"
      },
      {
        "date": "Week 5-6",
        "description": "Legal review and final due diligence"
      },
      {
        "date": "Week 7-8",
        "description": "Final negotiations and agreement execution"
      }
    ]
  },
  "margin_cost_data": {
